...
DROP SEQUENCE LEVEL1_LEI_RECORD_SEQ ;
...
CREATE SEQUENCE LEVEL1_LEI_RECORD_SEQ INCREMENT BY 200 MAXVALUE 9999999999 RESET BY SELECT IFNULL(MAX(LEI_ID), 0) + 1 FROM LEVEL1_LEI_RECORD;

CREATE SEQUENCE LEVEL2_EXCEPTION_REASON_SEQ INCREMENT BY 200 MAXVALUE 9999999999 RESET BY SELECT IFNULL(MAX(EXCEPTION_REASON_ID), 0) + 1 FROM LEVEL2_EXCEPTION_REASON;

CREATE SEQUENCE LEVEL2_EXCEPTION_REFERENCE_SEQ INCREMENT BY 200 MAXVALUE 9999999999 RESET BY SELECT IFNULL(MAX(EXCEPTION_REFERENCE_ID), 0) + 1 FROM LEVEL2_EXCEPTION_REFERENCE;

CREATE SEQUENCE LEVEL2_RELATIONSHIP_RECORD_SEQ INCREMENT BY 200 MAXVALUE 9999999999 RESET BY SELECT IFNULL(MAX(RR_ID), 0) + 1 FROM LEVEL2_RELATIONSHIP_RECORD;

CREATE SEQUENCE LEVEL2_REPORTING_EXCEPTION_SEQ INCREMENT BY 200 MAXVALUE 9999999999 RESET BY SELECT IFNULL(MAX(EXCEPTION_ID), 0) + 1 FROM LEVEL2_REPORTING_EXCEPTION;

CREATE SEQUENCE LEVEL2_RR_RELATIONSHIP_QUALIFIER_SEQ INCREMENT BY 200 MAXVALUE 9999999999 RESET BY SELECT IFNULL(MAX(QUALIFIER_RR_ID), 0) + 1 FROM LEVEL2_RR_RELATIONSHIP_QUALIFIER;

CREATE SEQUENCE LEVEL2_RR_RELATIONSHIP_QUANTIFIER_SEQ INCREMENT BY 200 MAXVALUE 9999999999 RESET BY SELECT IFNULL(MAX(QUANTIFIER_RR_ID), 0) + 1 FROM LEVEL2_RR_RELATIONSHIP_QUANTIFIER;
