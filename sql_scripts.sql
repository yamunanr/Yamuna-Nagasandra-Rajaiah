...
HQ_lang varchar(10),
L_First_Address_Line varchar(500),
L_Address_Number varchar(500),
L_City varchar(500),
L_Region  varchar(10),
L_Country varchar(10),
L_PostalCode varchar(500),
L_Lang_1 varchar(10),
Legal_Form_Type_Entity_Legal_Form_Code varchar(500),
Legal_Form_Type_Other_Legal_Form varchar(500),
O_First_Address_Line varchar(500),
O_Address_Number varchar(500),
O_Address_Number_Within_Building varchar(500),
O_Mail_Routing_1 varchar(500),
O_Additional_Address_Number_Line  varchar(500),
O_Additional_Address_Number varchar(500),
O_Additional_Address_Number_Within_Building varchar(500),
O_City varchar(500),
O_Region  varchar(10),
O_Country varchar(10),
O_PostalCode varchar(500),
O_Lang varchar(10),
O_Type  varchar(10),
...
TO_First_Address_Line varchar(500),
TO_Address_Number varchar(500),
TO_Address_Number_Within_Building varchar(500),
TO_Mail_Routing varchar(500),
TO_Additional_Address_Line_1  varchar(500),
TO_Additional_Address_Line_2 varchar(500),
TO_Additional_Address_Line_3 varchar(500),
TO_City varchar(500),
TO_Region  varchar(10),
TO_Country varchar(10),
TO_PostalCode varchar(500),
TO_Lang varchar(10),
TO_Type  varchar(10),
