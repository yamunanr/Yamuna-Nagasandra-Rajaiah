...
L_Region_1  varchar(6),
L_Country_1 varchar(2),
...
O_Region_1  varchar(6),
O_Country_1 varchar(2),
...
Extension_Type varchar(500),
Registration_Next_Renewal_Date varchar(500),
...
CREATE SEQUENCE LEVEL2_EXCEPTION_REASON_SEQ INCREMENT BY 1 MAXVALUE 9999999999 RESET BY SELECT IFNULL(MAX(EXCEPTION_REASON_ID), 0) + 1 FROM LEVEL2_EXCEPTION_REASON;

CREATE SEQUENCE LEVEL2_EXCEPTION_REFERENCE_SEQ INCREMENT BY 1 MAXVALUE 9999999999 RESET BY SELECT IFNULL(MAX(EXCEPTION_REFERENCE_ID), 0) + 1 FROM LEVEL2_EXCEPTION_REFERENCE;

CREATE SEQUENCE LEVEL2_RELATIONSHIP_RECORD_SEQ INCREMENT BY 1 MAXVALUE 9999999999 RESET BY SELECT IFNULL(MAX(RR_ID), 0) + 1 FROM LEVEL2_RELATIONSHIP_RECORD;

CREATE SEQUENCE LEVEL2_REPORTING_EXCEPTION_SEQ INCREMENT BY 1 MAXVALUE 9999999999 RESET BY SELECT IFNULL(MAX(EXCEPTION_ID), 0) + 1 FROM LEVEL2_REPORTING_EXCEPTION;

CREATE SEQUENCE LEVEL2_RR_RELATIONSHIP_QUALIFIER_SEQ INCREMENT BY 1 MAXVALUE 9999999999 RESET BY SELECT IFNULL(MAX(QUALIFIER_RR_ID), 0) + 1 FROM LEVEL2_RR_RELATIONSHIP_QUALIFIER;

CREATE SEQUENCE LEVEL2_RR_RELATIONSHIP_QUANTIFIER_SEQ INCREMENT BY 1 MAXVALUE 9999999999 RESET BY SELECT IFNULL(MAX(QUANTIFIER_RR_ID), 0) + 1 FROM LEVEL2_RR_RELATIONSHIP_QUANTIFIER;
